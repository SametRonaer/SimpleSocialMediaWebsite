...
body { 
   ...
   .navbar a {
	...
	height: 100%;
    width: 100%;
    background-image: url("1/The Elder Scrolls V- Skyrim is the big, bold, and beautiful.jpg");
	...
	height: 100%;
    width: 100%;
    background-image: url("2/God of War review.jpg");
    background-size: 100% 100%;
    border-radius: 20px ;
    color:white;
	...
	height: 100%;
    width: 100%;
    background-image: url("3/Sims4 review.jpg");
    background-size: 100% 100%;
    border-radius: 20px ;
    color:white;
	...
	height: 100%;
    width: 100%;
    background-image: url("4/Some tricks for Persona5.jpg");
    background-size: 100% 100%;
    color:white;
    border-radius: 20px ;
    ...
    width: 100%;
    color: black;
    background-image: url("5/Summary of Marvel vs Capcom Infinite.png");
    background-size: 100% 100%;
    border-radius: 20px ;
    color:white;
	...
	height: 100%;
    width: 100%;
    background-image: url("6/Some strategies for Anno.jpg");
    background-size: 100% 100%;
    border-radius: 20px ;
    color:white;
	...
	height: 100%;
    width: 100%;
    background-image: url("7/Rainbow Six Siege- Ubisoft reveals new season details.jpg");
    background-size: 100% 100%;
    border-radius: 20px ;
    color:white;
	...
	height: 100%;
    width: 100%;
    background-image: url("8/Monster Hunter movie adaptation in the works, starring Milla Jovovich.jpg");
    background-size: 100% 100%;
    border-radius: 20px ;  
    color:white;  
}
	...
	height: 100%;
    width: 100%;
    background-image: url("9/Battlefield 1 Easter egg yields Battlefield 5's reveal date.jpg");
    background-size: 100% 100%;
    border-radius: 20px ;
    color:white;
...
<div class = 'row'>
	...
	<a href="../../okul_deneme/sablon.php?name=33" > 
	<div id = 'firstRow1' onmouseover="bigImg(this)" onmouseout="normalImg(this)"> 
	<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	<h1>The Elder Scrolls V- Skyrim is the big, bold, and beautiful</h1>
	</div>
	</a>
	 </div> 
...
<div id = "secondRow"> 
 ...
 <div class = "row">
	...
	<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	<h1>Some tricks for Persona5</h1>
	</div>
	</a>
	 </div> 
	...
	<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	<h1>Summary of Marvel vs Capcom Infinite</h1>
	</div>
...
<div id = "thirdRow"> 
 ...
 <div class = "row">
	...
	<a href="../../okul_deneme/sablon.php?name=39" > 
	<div id = "thirdRow2" onmouseover="bigImg(this)" onmouseout="normalImg(this)"> 
	<br><br><br><br><br><br><br><br><br><br><br>
	<h3>Rainbow Six Siege- Ubisoft reveals new season details</h3>
	</div>
	</a>
	 </div>
	...
	<a href="../../okul_deneme/sablon.php?name=40" > 
	<div id = "thirdRow3" onmouseover="bigImg(this)" onmouseout="normalImg(this)"> 
	<br><br><br><br><br><br><br><br><br><br><br>
	<h3>Monster Hunter movie adaptation in the works, starring Milla Jovovich</h3>
	</div>
	</a>
	 </div> 
	...
	<a href="../../okul_deneme/sablon.php?name=41" > 
	<div id = "thirdRow4" onmouseover="bigImg(this)" onmouseout="normalImg(this)"> 
	<br><br><br><br><br><br><br><br><br><br>
	<h3>Battlefield 1 Easter egg yields Battlefield 5's reveal date</h3>
	</div>
